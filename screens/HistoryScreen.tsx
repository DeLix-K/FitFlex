...
const FILTERS: { label: string; value: AiHistoryKind | 'all' }[] = [
  ...
  { label: 'Readiness Tips', value: 'wellness_recommendation' },
  { label: 'Sleep', value: 'sleep_insight' },
  { label: 'Bedtime Stories', value: 'bedtime_story' },
...
const KIND_LABELS: Record<AiHistoryKind, string> = {
  ...
  wellness_recommendation: 'Readiness Tip',
  sleep_insight: 'Sleep',
...
const KIND_COLORS: Record<AiHistoryKind, string> = {
  ...
  wellness_recommendation: '#5eead4',
  sleep_insight: '#818cf8',
  bedtime_story: '#a78bfa',
